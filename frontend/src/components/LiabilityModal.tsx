    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-[14px]">
          ...
          <div>
            <label className="block text-[12.5px] font-semibold text-muted mb-[6px]">{language === 'th' ? `ยอดหนี้สิน (${currency})` : `Outstanding Balance (${currency})`}</label>
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 py-[10px] px-[14px] rounded-[12px] border border-inputBorder bg-white text-[14px] text-dark placeholder-muted/50 focus:outline-none focus:border-terracotta transition-colors shadow-sm"
